...
* `material.glsl` uniforms: `frx_matCutout`, `frx_matUnmipped`, `frx_matExposure`
...
* [LumiLightsPlus](https://modrinth.com/resourcepack/lumi-lights-plus), [LumiLights](https://github.com/spiralhalo/LumiLights/releases),
