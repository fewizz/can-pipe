...
public class CanPipeVertexFormatElements {
    ...
    static {
        ...
        MATERIAL_INDEX = VertexFormatElement.register(8, 0, VertexFormatElement.Type.INT, VertexFormatElement.Usage.UV, 1);
        TANGENT = VertexFormatElement.register(9, 0, VertexFormatElement.Type.BYTE, VertexFormatElement.Usage.NORMAL, 4);
    }
}
